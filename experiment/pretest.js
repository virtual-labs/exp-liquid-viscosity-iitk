...
/////////////// Write the MCQ below in the exactly same described format ///////////////
  ...
  const myQuestions = [
    {
      question: "The principle on which the viscosity measurement experiment based is:",  ///// Write the question inside double quotes
      answers: {
        a: "Stokes’s law",                  ///// Write the option 1 inside double quotes
        b: "Reynolds’s law",                  ///// Write the option 2 inside double quotes
        c: "Ohm’s law ",                  ///// Write the option 3 inside double quotes
        d: "Coulomb’s law"                   ///// Write the option 4 inside double quotes
      },
...

    {
     question: ". In viscosity measurement experiment on increasing the temperature of liquid the terminal velocity of the ball:",  ///// Write the question inside double quotes
      answers: {
        ...
        c: "remains same",                  ///// Write the option 3 inside double quotes
